...
class WC_AvaTax_API_Void_Request extends \WC_AvaTax_API_Company_Request {
	...
	public function void_order( $order_id ) {
		...
		$transaction_code = wc_avatax()->wc_avatax_utilities()->get_order_meta( $order_id, '_order_key', true );
	...
	public function void_refund( WC_Order_Refund $refund ) {
		...
		$order_key = wc_avatax()->wc_avatax_utilities()->get_order_meta( $refund->get_parent_id( 'edit' ), '_order_key', true );
