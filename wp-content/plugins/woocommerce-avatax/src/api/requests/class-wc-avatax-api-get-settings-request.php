 ...
 * @since 2.8.0
 */
class WC_AvaTax_API_Get_Settings_Request extends WC_AvaTax_API_Request {
	...
	public function __construct($userName) {
		...
		$this->path = "/active-applications/".$application_id."/configs/" . $website_id."/sections/".$schema_id."?configOnly=false&schema=false&v=". idate('U');
		$this->method = 'GET';
	}
}
