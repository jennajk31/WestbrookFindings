...
class WC_AvaTax_Order_Handler {
	...
	protected function add_hooks() {
		...
		add_action( 'woocommerce_order_status_processing_to_completed',  array( $this, 'process_paid_order' ) );
	 ...
	 *
	 */
	function custom_order_after_calculate_totals($order) {
	...
	public function calculate_order_tax( WC_Order $order, $commit = false, $update_item_taxes = false ) {
		...
		remove_action( 'woocommerce_order_after_calculate_totals', [ $this, 'custom_order_after_calculate_totals' ], 998 );
