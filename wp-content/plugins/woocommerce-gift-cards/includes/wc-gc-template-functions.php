		...
		<div class="wc_gc_field wc_gc_giftcard_cc form-row">
			<label for="wc_gc_giftcard_cc"><?php esc_html_e( 'CC', 'woocommerce-gift-cards' ); ?></label>
															<?php
																/* translators: delimiter */
															?>
			<input type="text" class="input-text" name="wc_gc_giftcard_cc" placeholder="<?php printf( esc_attr__( 'Enter additional emails to receive a gift card copy, separated by comma (%s)', 'woocommerce-gift-cards' ), esc_attr( wc_gc_get_emails_delimiter() ) ); ?>" value="<?php echo esc_attr( $value ); ?>"/>
