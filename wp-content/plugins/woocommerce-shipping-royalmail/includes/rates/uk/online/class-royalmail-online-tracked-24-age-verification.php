...
class RoyalMail_Online_Tracked_24_Age_Verification extends RoyalMail_Rate {
	...
	/**
	 * Setup RoyalMail_Online_Tracked_24_Age_Verification rates.
	 */
	...
	public function get_quotes( $items, $packing_method, $destination, $boxes = array(), $instance_id = '' ) {
		 ...
		 * @since 3.2.4
		 */
		$tube_packages           = apply_filters( 'woocommerce_shipping_royal_mail_tube_enabled', true, $instance_id, Services::TRACKED_24_AGE_VERIFICATION, $destination, $packing_method ) ? $this->get_tube_packages( $items, $destination, $packing_method ) : array();
