...
class RoyalMail_Regular_Tracked_48 extends RoyalMail_Rate {
	...
	/**
	 * Constructor for RoyalMail_Regular_Tracked_48 class
	 */
	...
	public function get_quotes( $items, $packing_method, $destination, $boxes = array(), $instance_id = '' ) {
		 ...
		 * @since 3.2.4
		 */
		$tube_packages           = apply_filters( 'woocommerce_shipping_royal_mail_tube_enabled', true, $instance_id, Services::TRACKED_48, $destination, $packing_method ) ? $this->get_tube_packages( $items, $destination, $packing_method ) : array();
