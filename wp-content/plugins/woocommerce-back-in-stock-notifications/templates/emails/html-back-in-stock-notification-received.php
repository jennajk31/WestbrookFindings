...
" id="notification__action_button">
		 ...
		 * @since 3.0.1
		 */
		echo esc_html( apply_filters( 'woocommerce_bis_email_received_button_text', _x( 'Shop Now', 'Email notification', 'woocommerce-back-in-stock-notifications' ), $notification ) );
		?>
		</a>
	</div>
