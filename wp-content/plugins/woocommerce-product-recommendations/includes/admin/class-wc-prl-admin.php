...
class WC_PRL_Admin {
	...
	public static function init() {
		...
		// Add body class.
		add_filter( 'admin_body_class', array( __CLASS__, 'maybe_include_admin_body_class' ) );
	...
	/**
	 * Include admin classes if on a PRL admin screen.
	 *
	 * @since 4.0.3
	 *
	 ...
	 * @return String
	 */
	public static function maybe_include_admin_body_class( $classes ) {
	...
	public static function init_meta_boxes() {
		...
		$load_metaboxes = (array) apply_filters(
			'woocommerce_prl_metaboxes',
			array(
