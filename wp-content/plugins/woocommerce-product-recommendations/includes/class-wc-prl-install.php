...
class WC_PRL_Install {
	...
	public static function install() {
		...
		// Display an incompatibility notice if a block theme is active.
		WC_PRL_Admin_Notices::add_maintenance_notice( 'block_theme' );
...
CREATE TABLE {$wpdb->prefix}woocommerce_prl_amplifier_cache (
	`id` BIGINT UNSIGNED NOT NULL auto_increment,
