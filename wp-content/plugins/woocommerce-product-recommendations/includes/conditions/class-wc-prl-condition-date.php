			...
			<div class="os_value">
				<div class="os_date_picker">
					<div class="sw-enhanced-select">
						<?php
						global $wp_locale;
						$month = '<select class="mm" name="' . esc_attr( $post_name ) . '[conditions][' . esc_attr( $condition_index ) . '][value][month]">\n"';
						for ( $i = 1; $i < 13; $i++ ) {
					...
					<div class="sw-enhanced-select">
						<?php
						$day = '<select class="dd" name="' . esc_attr( $post_name ) . '[conditions][' . esc_attr( $condition_index ) . '][value][day]">\n"';
						for ( $i = 1; $i < 32; $i++ ) {
					...
					<div class="sw-enhanced-select">
						<?php
						$year = '<select class="yy" name="' . esc_attr( $post_name ) . '[conditions][' . esc_attr( $condition_index ) . '][value][year]">\n"';
