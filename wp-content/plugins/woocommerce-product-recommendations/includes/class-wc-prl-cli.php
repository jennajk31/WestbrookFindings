...
class WC_PRL_CLI {
	...
	private function includes() {
		...
		require_once WC_PRL_ABSPATH . 'includes/cli/class-wc-prl-cli-process-amplifier-generation-queue.php';
	}
	...
	private function hooks() {
		...
		WP_CLI::add_hook( 'after_wp_load', 'WC_PRL_CLI_Process_Amplifier_Generation_Queue::register_command' );
	}
}
